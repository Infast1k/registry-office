	...
	<ul class="relative m-0 list-none px-[0.2rem] pb-12" data-te-sidenav-menu-ref>
		<li class="relative">
			...
			>
				...
				<span class="text-text hover:text-text-hover">Overview</span>
			</a>
		</li>
		<li class="relative pt-4">
			<span class="px-6 py-4 text-[0.6rem] font-bold uppercase text-text">Create</span>
			<a
				class="flex cursor-pointer items-center truncate rounded-[5px] px-6 py-[0.45rem] text-[0.85rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-50 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
				data-te-sidenav-link-ref
				href="#!"
			>
				...
				<span class="text-text hover:text-text-hover">Project</span>
			</a>
		</li>
		<li class="relative">
			<a
			...
			>
				...
				<span class="text-text hover:text-text-hover">Database</span>
			</a>
		</li>
		<li class="relative pt-4">
			<span class="px-6 py-4 text-[0.6rem] font-bold uppercase text-text">Manage</span>
			<a
				class="flex cursor-pointer items-center truncate rounded-[5px] px-6 py-[0.45rem] text-[0.85rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-50 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
				data-te-sidenav-link-ref
				href="#!"
			>
				...
				<span class="text-text hover:text-text-hover">Projects</span>
			</a>
		</li>
		<li class="relative">
			<a
			...
			>
				...
				<span class="text-text hover:text-text-hover">Databases</span>
			</a>
		</li>
		<li class="relative">
			<a
			...
			>
				...
				<span class="text-text hover:text-text-hover">Custom domains</span>
			</a>
		</li>
		<li class="relative">
			<a
			...
			>
				...
				<span class="text-text hover:text-text-hover">Repositories</span>
			</a>
		</li>
		<li class="relative">
			<a
			...
			>
				...
				<span class="text-text hover:text-text-hover">Team</span>
			</a>
		</li>
	</ul>
</nav> -->